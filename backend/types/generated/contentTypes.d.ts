...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tasks that users can complete for XP';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mentionedUsers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiShopCardShopCard extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Shop Card';
    pluralName: 'shop-cards';
    singularName: 'shop-card';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTeamUserTeamUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    team: Schema.Attribute.Relation<'manyToOne', 'api::team.team'> &
      Schema.Attribute.Required;
    teamRole: Schema.Attribute.Relation<
      'manyToOne',
      'api::team-role.team-role'
    > &
      Schema.Attribute.Required;
...
export interface ApiUserChallengeUserChallenge
  ...
  info: {
    description: 'User submissions and approval status for challenges';
    displayName: 'User Challenge';
    pluralName: 'user-challenges';
    singularName: 'user-challenge';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-challenge.user-challenge'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['pending', 'approved', 'rejected']> &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    globalRole: Schema.Attribute.Enumeration<
      ['admin', 'project_manager', 'worker']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'worker'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
